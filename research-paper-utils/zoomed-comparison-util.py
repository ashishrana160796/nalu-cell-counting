...
ax[0][0].text(0.5,-0.25, '(a) Normal cell image', size=14, ha="center", transform=ax[0][0].transAxes)
# ax[0][1].set_title('(b) Zoomed cell image')
ax[0][1].text(0.5,-0.25, '(b) Zoomed cell image', size=14, ha="center", transform=ax[0][1].transAxes)
# ax[1][0].set_title('(c) Normal annotated image')
ax[1][0].text(0.5,-0.25, '(c) Normal annotated image', size=14, ha="center", transform=ax[1][0].transAxes)
# ax[1][1].set_title('(d) Zoomed annotated image')
ax[1][1].text(0.5,-0.25, '(d) Zoomed annotated image', size=14, ha="center", transform=ax[1][1].transAxes)
